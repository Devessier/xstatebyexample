...
import type { Circle, Circles, Position } from "./types";
...
export const machine = setup({
  ...
  context: () => {
    // TODO: make the boundaries be the width, x and y of the container below
    const container = document.querySelector("#circle-drawer-example");
