...
import { Content as DemoMachineCode } from '../../examples/notification/machine.md';
import { Content as DemoReactCode } from '../../examples/notification/Demo.md';
...
[The Notification Center example](/notification-center/) is based on this example. It adds the feature of stacked notifications and manages it with actors.
